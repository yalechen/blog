...
<html lang="en">  
  <head>
    ...
    <script type="text/javascript" src="{asset('admin/plugins/validation/jquery.validate.min.js')}"></script>
    <script type="text/javascript" src="{asset('admin/plugins/nprogress/nprogress.js')}"></script>
